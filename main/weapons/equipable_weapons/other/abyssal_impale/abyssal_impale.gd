...
func _spawn_crystal_spike(spawn_pos: Vector2, dmg: float):
	...
	main_spike.polygon = PackedVector2Array(
		[Vector2(-6, 0), Vector2(6, 0), Vector2(4, -30), Vector2(0, -75), Vector2(-5, -45)]
	)
	...
	right_shard.polygon = PackedVector2Array(
		[Vector2(3, 0), Vector2(10, 0), Vector2(14, -15), Vector2(8, -35), Vector2(5, -10)]
	)
	...
	left_shard.polygon = PackedVector2Array(
		[Vector2(-4, 0), Vector2(-12, 0), Vector2(-15, -12), Vector2(-9, -28), Vector2(-6, -15)]
	)
