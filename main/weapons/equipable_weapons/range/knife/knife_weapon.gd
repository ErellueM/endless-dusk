...
func get_upgrade_info(next_level: int) -> Dictionary:
	match next_level:
		2:
			return {
				"desc": "[color=green]+1 Projectile[/color]\nFires an additional knife.",
				"rarity": "Common"
			}
		3:
			return {
		...
		4:
			return {
				"desc": "[color=green]+20% Projectile Speed[/color]\nKnives fly much faster.",
				"rarity": "Common"
			}
		5:
			return {
				"desc":
				"[color=green]Apply Poison[/color]\n[color=red]Deals damage over time.[/color]",
				"rarity": "Legendary"
			}
